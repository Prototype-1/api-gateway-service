...
const (
	...
	AdminService_AdminGetDetails_FullMethodName = "/admin.AdminService/AdminGetDetails"
)
...
func (c *adminServiceClient) AdminGetDetails(ctx context.Context, in *AdminRequest, opts ...grpc.CallOption) (*AdminResponse, error) {
	...
	err := c.cc.Invoke(ctx, AdminService_AdminGetDetails_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdminService_AdminGetDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AdminService_AdminGetDetails_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
